...
//    @ApiOperation(value = "글번호에 해당하는 공지사항 정보를 반환한다.", response = Board.class)    
	@GetMapping("{no}")
...
//    @ApiOperation(value = "글번호에 해당하는 공지사항 정보를 수정한다. 그리고 DB수정 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
...
//    @ApiOperation(value = "글번호에 해당하는 공지사항 정보를 삭제한다. 그리고 DB삭제 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
